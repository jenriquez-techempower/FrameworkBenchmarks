...
to that language. See the [Language README Formatting Guide](./Readme-Formats#language-readmes) 
...
to that framework. See the [Framework README Formatting Guide](./Readme-Formats#framework-readmes) 
for a more detailed guide.
...
benchmark, please refer to the [benchmarking section](./Contributing-Getting-Started-Benchmarking).
...
[Travis-CI](./Travis-CI) section for more information.
